                    ...
                    <Paper className={classes.paper}
                        ...
                        <Grid container justify="center"
                            ...
                            >
                                <HLSSource
                                    isVideoChild
                                    src={process.env.REACT_APP_VIDEO_URL + post.video}
                                />
                            </Player>
                        </Grid>
                    </Paper>
                        ...
                        <Table style={{ marginTop: "10px" }}>
                            ...
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell className={classes.tablePostViewBody}>
                                        <span className={classes.postViewSpan}>
                                            {numberWithCommas(post.score)}
                                        </span>
                                    </TableCell>
                                    <TableCell className={classes.tablePostViewBody}>
                                        <span className={classes.postViewSpan}>
                                            {numberWithCommas(post.like_cnt)}
                                        </span>
                                    </TableCell>
                                    <TableCell className={classes.tablePostViewBody}>
                                        <span className={classes.postViewSpan}>
                                            {numberWithCommas(post.reply_cnt)}
                                        </span>
                                    </TableCell>
                                    <TableCell className={classes.tablePostViewBody}>
                                        <span className={classes.postViewSpan}>
                                            {numberWithCommas(post.dibs_cnt)}
                                        </span>
                                    </TableCell>
                                    <TableCell className={classes.tablePostViewBody}>
                                        <span className={classes.postViewSpan}>
                                            {numberWithCommas(post.number_of_sponsor)}
                                        </span>
                                    </TableCell>
                                    <TableCell className={classes.tablePostViewBody}>
                                        <span
                                            className={classes.postViewSpan}
                                        >
                                            {numberWithCommas(post.total_sponsor_points)}
                                        </span>
                                    </TableCell>
                                </TableRow>
                            </TableBody>
                                ...
                                <TableBody>
                                    <TableRow key={row.id}>
                                        <TableCell width={72}>
                                            ...
                                            >{row.nickname ? row.nickname.slice(0, 1) : ""}</Avatar>
                                        </TableCell>
                                        <TableCell
                                            style={{
                                                width: "10%"
