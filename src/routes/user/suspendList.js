...
export default (props) => {
    ...
    const dataReq = () => {
        return new Promise(async (r, e) => {
            ...
            let url = `/api/v1/admin/user/manage/suspend/list?limit=${limit}&offset=${offset}&keyword=${search}&is_creator=${type}`
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={8}>
                        <Typography component="h2" variant="h5" color="initial" gutterBottom
                            ...
                            정지 회원 목록
                            <span style={{color:"#A6A6A6", fontSize:"18px"}} >(총 {listTotal}개)</span>
                        </Typography>
                ...
                <Grid container spacing={3} className={classes.tableTop}>
                    <Grid item xs={12} sm={4}>
                        ...
                        >
                            ...
                            <MenuItem value={1}>크리에이터</MenuItem>
                        </Select>
                    </Grid>
                    <Grid item xs={12} sm={4}>
                        ...
                        <Table className={classes.table}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell className={classes.tableCell} align="center">회원 유형</TableCell>
                                    <TableCell className={classes.tableCell} align="center">가입일</TableCell>
                                    ...
                                    <TableCell className={classes.tableCell} align="center">휴대폰 번호</TableCell>
                                    <TableCell className={classes.tableCell} align="center">회원 이메일</TableCell>
                                    <TableCell className={classes.tableCell} align="center">회원 정지 유무</TableCell>
