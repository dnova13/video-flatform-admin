...
export default (props) => {
    ...
    const moreBtnHandler = (d) => {
        setSession()
        history.push('/admin/report/reply/item/{0}'.format(d.id))
    }
    ...
    const dataReq = () => {
        return new Promise(async (r, e) => {
            ...
            let url = `/api/v1/admin/report/list/reply?limit=${limit}&offset=${offset}&keyword=${search}&category_id=${type}`
                        ...
                        <Table className={classes.table}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell className={classes.tableCell} align="center">신고된 회원 닉네임</TableCell>
