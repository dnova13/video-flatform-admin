...
export default (props) => {
    ...
    const moreBtnHandler = (d) => {
        setSession()
        history.push('/admin/service/notice/item/{0}'.format(d.id))
    }
    ...
    const dataReq = () => {
        return new Promise(async (r, e) => {
            ...
            let url = `/api/v1/admin/service/notice/list?limit=${limit}&offset=${offset}&keyword=${search}`
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} sm={2}>
                        <Button
                            ...
                            onClick={() => {
                                setSession()
                                history.push('/admin/service/notice/item')
                            }}
                        >추가</Button>
                    </Grid>
                    {/*<Grid item xs={12} sm={2}>
